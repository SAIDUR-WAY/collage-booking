    ...
    <div>
      <div className="hero w-full min-h-600 bg-base-200">
        <div className="hero-content flex-col lg:flex-row">
          ...
          <div className="card flex-shrink-0 md:w-1/2  shadow-2xl bg-[#AACBFF]">
            ...
            {error  && (
              ...
              <div className="form-control relative">
                ...
                {
                  show ? 
                  <FaRegEye onClick={()=>setShow(!show)} className='absolute text-2xl right-8 top-12 '/>
                  :
                  <FaRegEyeSlash onClick={()=>setShow(!show)} className='absolute text-2xl right-8 top-12'/>
                }
              ...
              <div className="form-control">
                <button className="btn hover:bg-[#044080] text-white bg-[#007CFF]">SignUp</button>
              </div>
            </form>
